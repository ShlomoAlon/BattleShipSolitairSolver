...
if __name__ == "__main__":
    ...
    # print("four_ship_domain")
    # print(board.four_ship_domain)
    # print("three_ship_domain")
    # print(board.three_ship_domain)
    # print("two_ship_domain")
    # print(board.two_ship_domain)
    # print("submarine_domain")
    # print(board.submarine_domain)
    # print("solve")
    # print(board.col_constraints)
    # print(board.row_constraints)
    # board.handle_simple_hints(board_str)
    # hinted = board.handle_complex_hints(board_str)
    # print(hinted)
